...
namespace GitTrends
{
    public class SettingsPage : BaseContentPage<SettingsViewModel>
    {
        ...
        enum Row { GitHubUser, GitHubUserSeparator, Login, LoginSeparator, Notifications, NotificationsSeparator, Theme, ThemeSeparator, Language, LanguageSeparator, PreferredCharts, PreferredChartsSeparator, CopyrightPadding, Copyright }
